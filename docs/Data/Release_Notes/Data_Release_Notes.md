...
* __Release Date__: October 29, 2025
...
* One RNA-Seq file from TCGA-OV (Data Type: Gene Expression Quantification) is marked as controlled-access and is not downloadable from the portal without dbGaP access. Click [here](https://api.gdc.cancer.gov/data/f649506e-afab-47b1-aec5-1c8ce68c2272) to download it as an open-access file.
