...
* Gene and mutation sets will no longer have autogenerated default names. <!--PEAR-2187-->
* Search functionality for all mutations tables have been extended to support searching by ssm_id. <!--PEAR-1513-->
* Filter cards for strings have beeen improved by preserving case sensitivity for display, validating duplicate entries, and providing error notifications for non-unique values. <!--PEAR-2218-->
...
* Analysis tools are now always sorted in alphabetical order in the Analysis Center. <!--PEAR-2354-->
