...
[![Zoom](./images/bamGbZoomIn.png)](./images/bamGbZoomIn.png "Click to see the full image.")
...
pair calls are shown. For strictness level = 'Lenient', there are two reads that support the
